...
$(function () {
    ...
    var retultTypeListAPI = APITitle + "api/Questionnaire/Recommend/" + AB_ID;
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                        if (data[i].Types == 1) {
                            type1Arry.push(data[i].Value);
                        } else {
                            type2Arry.push(data[i].Value);
                        }
                //console.log(i)
            }
            r1++;
    ...
    $.ajax({
        ...
        success: function success(data) {
            ...
            //$("#pChose .contentTr").eq(0).find(".y_checkbox").attr("checked","checked")
        }
    ...
    $(".main #submit").click(function () {
        ...
        for (var i = 0; i < advArry.length; i++) {
           // console.log(type2Arry.indexOf(advArry[i]));
            if (type2Arry.indexOf(advArry[i]) != -1) {
        ...
        if (reslutType2Arry.length > 0) {
            ...
            for (var i = 0; i < allListArry.length;i++){
                if (allListArry[i].AS_ID == needAs_ID) {
                    ...
                    //    for (var j = 0; j < type2Arry.length; j++) {
                    //        if (resultArry[i] == type2Arry[j]) {
                    //            for (var k = 0; k < allListArry.length; k++) {
                    //                if (resultArry[i] == allListArry[k].AS_ID) {
                    //                    resultAS_ID = allListArry[k].AS_ID;
                    //                    resultArryK = allListArry[k].Fore_Filed3;
                    //                    console.log(allListArry[k].Name)
                    //                    break;
                    //                }
                    //                break;
                    //            }
...
function addordelArry(e) {
        ...
        if(type2Arry.indexOf(cResult)!=-1){
