...
$(function () {
    ...
    subPage.checkHasAB_ID(login,userTel, AB_ID);
    $.ajax({
        type: 'get',
        url: backAPIUrl,
        data: {},
...
var subPage = {
    checkHasAB_ID: function checkHasAB_ID(login,userTel, checkID) {
        if (checkID == "" || checkID == null || checkID == undefined || userTel == "" || userTel == undefined || userTel == null) {
